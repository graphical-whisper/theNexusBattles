...
export default class AleatoryAttackEffect implements AleatoryEffectsFactory {
  ...
  constructor(probabilities: number[], outcomes: string[]) {
    ...
    this.aleatoryValueGenerator =
      AleatoryVariableGenerationManager.getInstance();
  }

  /**
   * Generates an aleatory attack effect based on predefined probabilities and outcomes.
   * @returns {string} A string representing the generated aleatory attack effect.
   */
